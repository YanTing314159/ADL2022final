...
if __name__ == "__main__":
    ...
    # load your bot
    bot = BlenderbotForConditionalGeneration.from_pretrained(args.model_name_or_path).to(device)
    bot_tokenizer = BlenderbotTokenizer.from_pretrained(args.model_name_or_path)
